...
import { CreateTransferStatementsController } from '../modules/statements/useCases/createTransferStatements/CreateTransferStatementsController';
...
statementRouter.post('/transfers/:user_id', createTransferStatementsController.handle);
